...
namespace DVCP.Controllers
{
    ...
    {
        private WeatherServiceSubject weatherService;
        public HomeController()
        {
            weatherService = new WeatherServiceSubject();
        }
        ...
        {
            WeatherDisplayObserver weatherDisplay = new WeatherDisplayObserver();
            weatherService.Attach(weatherDisplay);

            // Giả lập việc cập nhật dữ liệu dự báo thời tiết
            weatherService.SetWeatherData("25°C", "80%", "Cloudy");

            ViewBag.Temperature = "25°C";
            ViewBag.Humidity = "80%";
            ViewBag.WeatherDescription = "Cloudy";
